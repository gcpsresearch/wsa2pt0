								...
								gen _ss = ss
                                 ...
                                 gen percOth = .
										...
										* case if taking typical # of core courses
                                         replace percOth = ot/6.25 if (la + ma + sc + ss) < = 17.25
										* case if core course taking is reducing taking other courses
                                         replace percOth = ot/(17.25 - (la + ma + sc + ss)) if (la + ma + sc + ss) > 17.25
                 ...
                 keep if grade_20${histyr1} == 10
								...
								gen _ss = ss
								 ...
								 gen percOth = .
										...
										* case if taking typical # of core courses
                                         replace percOth = ot/4.5 if (la + ma + sc + ss) < = 11.5
										* case if core course taking is reducing taking other courses
                                         replace percOth = ot/(11.5 - (la + ma + sc + ss)) if (la + ma + sc + ss) > 11.5
                                         replace percOth = 2 if percOth < 0 | percOth > 2
         ...
         ***********************
                 keep if grade_20${histyr1} == 9
								...
								gen percOth = .
										...
										* case if taking typical # of core courses
                                         replace percOth = (ot + ss)/3 if (la + ma + sc) < = 5.75
                                         replace percOth = (ot + ss)/(5.75 - (la + ma + sc)) if (la + ma + sc) > 5.75
                                         replace percOth = 2 if percOth < 0 | percOth > 2
